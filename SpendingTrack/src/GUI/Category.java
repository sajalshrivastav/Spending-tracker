...
public class Category extends javax.swing.JFrame {
    ...
    void getEntries(){
         try{
                        javax.swing.table.DefaultTableModel dtm=( javax.swing.table.DefaultTableModel)table_entry.getModel();
int rc=dtm.getRowCount();
while(rc--!=0){
dtm.removeRow(0);
}
//        Connection c= DriverManager.getConnection("jdbc:mysql://localhost:3306/spendingdb"+"?useSSl=false", "root", "root");
...
//           dtm.addRow(o);
    ...
    private void initComponents() {
        ...
        table_entry = new javax.swing.JTable();
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(addcategory, javax.swing.GroupLayout.PREFERRED_SIZE, 248, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        table_entry.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(table_entry);
...
int r=   JOptionPane.showConfirmDialog(null, 
       ...
       if(r==JOptionPane.YES_OPTION){
           int ri=table_entry.getSelectedRow();
  String category=(String)table_entry.getValueAt(ri, 1);
...
//              "root" , "root");
//      Statement s=c.createStatement();
      //NOTE:this exceute update is not message but a sql query command  
   ...
   JOptionPane.showMessageDialog(null,ex);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
           ...
           db.DbConnect.st.executeUpdate("insert into category value('"+category+"')");
    ...
    private javax.swing.JTable table_entry;
